...
# ======================================================
    def run_new(self, n_anom = 10) -> Dict[str, list]:
        """
        ...
        result_dataframes.update({
            'cols': cols,
            'X_train': final_X_train.to_numpy().tolist(),
            'X_val': final_X__val.to_numpy().tolist(),
            'X_test': final_X__test.to_numpy().tolist(),

            'y_train': final_Y_train.tolist(),
            'y_val': final_Y__val.tolist(),
            'y_test': final_Y__test.tolist()
            })
